...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="{{ url('design/adminlte')}}///oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="{{ url('design/adminlte')}}///oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <a href="{{ aurl('forgot/password')}}">Forgot my password</a><br>
